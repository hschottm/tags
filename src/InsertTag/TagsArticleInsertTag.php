...
class TagsArticleInsertTag implements InsertTagResolverNestedResolvedInterface
{
    public function __invoke(ResolvedInsertTag $insertTag): InsertTagResult
    {
        ...
        $res = TagHelper::tagsForTableAndId('tl_article', $parameter, false, $max_tags, $relevance, $target);

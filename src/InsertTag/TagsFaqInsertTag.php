...
class TagsFaqInsertTag implements InsertTagResolverNestedResolvedInterface
{
    public function __invoke(ResolvedInsertTag $insertTag): InsertTagResult
    {
        ...
        $res = TagHelper::tagsForTableAndId('tl_faq', $parameter, false, $max_tags, $relevance, $target);

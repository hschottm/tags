...
class TagsContentInsertTag implements InsertTagResolverNestedResolvedInterface
{
    public function __invoke(ResolvedInsertTag $insertTag): InsertTagResult
    {
        ...
        $res = TagHelper::tagsForTableAndId('tl_content', $parameter, false, $max_tags, $relevance, $target);

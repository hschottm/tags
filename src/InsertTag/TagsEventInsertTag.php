...
class TagsEventInsertTag implements InsertTagResolverNestedResolvedInterface
{
    public function __invoke(ResolvedInsertTag $insertTag): InsertTagResult
    {
        ...
        $res = TagHelper::tagsForTableAndId('tl_calendar_events', $parameter, false, $max_tags, $relevance, $target);
